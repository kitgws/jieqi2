...
function loadRateCSS(){
	...
	var style = "";
	style +=".ratediv{font-size:" + fonttxt + "px; height:" + divheight + "px;line-height:" + divheight + "px;}\n";
	...
	style +=".rateunit li a:hover{background: url('" + rate_image_url + "') left center; z-index: 10; left: 0px; height: " + rate_star_height + "px;}\n";
	var starlen = 0;
