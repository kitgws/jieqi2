<?php
echo '<form name="frmsearch" method="get" action="'.$this->_tpl_vars['jieqi_url'].'/admin/ptopiclist.php">
<table class="grid" width="100%" align="center">
    <tr>
      <td>
	  <span class="fr">[<a href="'.$this->_tpl_vars['jieqi_url'].'/admin/ptopiclist.php?type=all">全部主题</a>] &nbsp;&nbsp; [<a href="'.$this->_tpl_vars['jieqi_url'].'/admin/ptopiclist.php?type=good">精华主题</a>]&nbsp;</span>
        关键字：
...
<form name="frmsearch" method="get" action="'.$this->_tpl_vars['jieqi_url'].'/admin/ptopiclist.php">
<table class="grid" width="100%" align="center">
  <tr align="center">
...
echo '<a href="'.$this->_tpl_vars['jieqi_url'].'/ptopicshow.php?tid='.$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['topicid'].'" target="_blank"';
...
echo '>'.$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['title'].'</a></td>
    <td><a href="'.jieqi_geturl('system','user',$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['uid']).'" target="_blank">'.$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['name'].'</a></td>
	...
	<td align="center"><a id="act_del_'.$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['topicid'].'" href="javascript:;" onclick="if(confirm(\'确实要删除该主题么？\')) Ajax.Tip(\''.$this->_tpl_vars['jieqi_url'].'/admin/ptopiclist.php?tid='.$this->_tpl_vars['topicrows'][$this->_tpl_vars['i']['key']]['topicid'].'&type='.$this->_tpl_vars['type'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\', {method: \'POST\'});">删除</a></td>
  </tr>
  ';
}
echo '
