...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
				<li>
<a href="'.$this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['url_chapter'].'">';
if($this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['isvip_n'] > 0){
echo '<img src="/wap/img/vip.png" alt="vip">';
}
echo $this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['chaptername'].'<em>('.$this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['size_c'].'×Ö)</em></a></li>';
}
