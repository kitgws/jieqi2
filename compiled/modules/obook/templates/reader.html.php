...
<html>
    ...
    <title>'.$this->_tpl_vars['chaptername'].'-'.$this->_tpl_vars['articlename'].'-'.$this->_tpl_vars['author'].'-'.$this->_tpl_vars['sort'].'-'.$this->_tpl_vars['jieqi_sitename'].'</title>
...
<article class="article-box clearfix">
    ...
    <h1 class="title">'.$this->_tpl_vars['chaptername'].'</h1>
    <div class="book-info"><a href="'.$this->_tpl_vars['url_articleinfo'].'"><img src="'.$this->_tpl_vars['url_image'].'" alt="'.$this->_tpl_vars['articlename'].'">
      <div class="text"><p>'.$this->_tpl_vars['articlename'].'</p></div>
      </a></div>
  </header>
      <div class="entry" id="read_conent_box"><p>'.$this->_tpl_vars['jieqi_content'].'</p></div>
...
<div class="item2p recharge_sc bh_recharge_box" style="display:none;">
    ...
    <div class="entry">
        ...
        <li><a class="dsbdimg d"><span class="jine"><img src="/slms/images/ds/1.png" alt="玫瑰" /></span><i class="cz-xian"></i>
		 ...
		 <div id="dsshu">
        <input type="radio" id="rid" name="rid" checked="checked" value="2">
      </div>
