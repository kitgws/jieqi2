...
<title>充值记录-'.$this->_tpl_vars['jieqi_pagetitle'].'</title>
...
<div class="wrapper"><!--头部 begin -->
  ...
  <div class="record-box mt-10">
    <div class="title">
      <ul>
        <li><a href="javascript:;" class="current">充值记录</a></li>
        <li><a href="/modules/article/myactlog.php" >打赏记录</a></li>
      </ul>
    </div>
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
        ...
        <div class="body"><span class="typo-red">'.$this->_tpl_vars['paylogrows'][$this->_tpl_vars['i']['key']]['paytype'].'</span></div>
        <div class="pull-right">
          <div class="text ';
if($this->_tpl_vars['paylogrows'][$this->_tpl_vars['i']['key']]['payflag'] == "未确认"){
echo 'weiqueren';
}
echo '">+'.$this->_tpl_vars['paylogrows'][$this->_tpl_vars['i']['key']]['egold'].'('.$this->_tpl_vars['paylogrows'][$this->_tpl_vars['i']['key']]['payflag'].')</div>
          <div class="date">日期: '.date('Y-m-d H:i:s',$this->_tpl_vars['paylogrows'][$this->_tpl_vars['i']['key']]['buytime']).'</div>
        </div>
      </div>
	  ';
}
