...
function userLogin(url)
{
	...
	msg +=("     <h3>用户注册</h3>");
	msg +=("     还没有本站网账号？");
	msg +=("     <a href=\""+HOST_URL+"register.php\" title=\"立即注册\" class=\"reg\"></a>");
	msg +=("     你也可以用站外账号登录:");
	msg +=("     <p class=\"o_login pt10\" style=\"width:200px;\"><a href=\"javascript:;\" onclick=\"otherlogin(\'\/api/qq/login.php\');\" title=\"腾讯QQ\" class=\"qq\"></a><a href=\"javascript:;\" onclick=\"otherlogin(\'\/api/weibo/login.php\');\" title=\"新浪微博\" class=\"sina\"></a><a href=\"#\" title=\"微信登录\" class=\"wechat\"></a><a href=\"#\" title=\"百度登录\" class=\"baidu\"></a></p>");
	msg +=("    </div>");
	msg +=("    </div><!--logn end-->");
	var i = $.layer({
		type : 1,
