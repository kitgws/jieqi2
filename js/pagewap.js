...
/*	
	...
	var pagei = layer.open({
	    ...
	    content: '<div class="container">'
	             ...
	             +'<div class="ft fcc"><a class="btn btn-auto btn-blue" href="{?$jieqi_url?}/api/qq/login.php">QQ登陆</a></div>'
	             +'<div class="ft fcc"><a class="btn btn-auto btn-blue" href="{?$jieqi_url?}/api/weibo/login.php">新浪微博登陆</a></div>'
	             +'</form>'
	             +'</div>'
	             +'</div>',
