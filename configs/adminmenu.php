...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '系统定义', 'command'=>JIEQI_URL.'/admin/configs.php?mod=system&define=1', 'target' => 0, 'publish' => 0);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '参数设置', 'command'=>JIEQI_URL.'/admin/configs.php?mod=system', 'target' => 0, 'publish' => 0);
...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => 'VIP等级管理', 'command'=>JIEQI_URL.'/admin/vips.php', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '小说推荐', 'command'=>JIEQI_URL.'/admin/blockfiles.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => '用户日志', 'command'=>JIEQI_URL.'/admin/userlog.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => '用户充值记录', 'command'=>$GLOBALS['jieqiModules']['pay']['url'].'/admin/paylog.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['tools'][] = array('layer' => 0, 'caption' => '刷新静态首页', 'command'=>JIEQI_URL.'/indexs.php', 'target' => 0, 'publish' => 0);
