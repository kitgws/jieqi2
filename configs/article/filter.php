...
//	'monthvipvote' => array('caption'=>'月月票', 'order'=>'monthvipvote DESC', 'limit'=>'lastvipvote >= <{$monthstart}>'),
	'allvipvote' => array('caption'=>'神之光芒', 'order'=>'allvipvote DESC'),
...
$jieqiFilter['article']['isfull'] = array(
	1 => array('caption'=>'连载', 'limit'=>'progress = 0'),
	5 => array('caption'=>'完本', 'limit'=>'progress = 4')
);

//VIP选项
$jieqiFilter['article']['isvip'] = array(
	1 => array('caption'=>'免费', 'limit'=>'isvip = 0'),
	2 => array('caption'=>'VIP', 'limit'=>'isvip > 0'),
	3 => array('caption'=>'签约', 'limit'=>'issign > 0'),
	4 => array('caption'=>'包月', 'limit'=>'isvip > 0 AND monthly > 0')
);
