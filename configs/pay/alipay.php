...
$jieqiPayset['alipay']['payid'] = '2088521219133719';  //合作伙伴ID（请输入实际申请的值）

$jieqiPayset['alipay']['paykey'] = '6pppd2q9xr2mj0nyqy9o4k9rrrbrgnfc';  //通讯密钥值（请输入实际申请的值）
...
$jieqiPayset['alipay']['seller_email'] = '1276208090@qq.com';  //卖家邮箱，必须填写
