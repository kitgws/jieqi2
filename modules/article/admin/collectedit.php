...
default:
	...
	$collect_form->addElement(new JieqiFormText($jieqiLang["article"]["rule_site_uid"], "siteid", 60, 50, htmlspecialchars($jieqiCollect["siteid"], ENT_QUOTES)), true);
	...
	$collect_form->addElement(new JieqiFormTextArea($jieqiLang["article"]["rule_article_vip"], "vip", htmlspecialchars(jieqi_collectstop($jieqiCollect["vip"]), ENT_QUOTES), 5, 60));
	...
	$collect_form->addElement(new JieqiFormTextArea($jieqiLang["article"]["rule_chapter_vip"], "chaptervip", htmlspecialchars(jieqi_collectstop($jieqiCollect["chaptervip"]), ENT_QUOTES), 5, 60), true);
	$collect_form->addElement(new JieqiFormTextArea($jieqiLang["article"]["rule_chapter_egold"], "egold", htmlspecialchars(jieqi_collectstop($jieqiCollect["egold"]), ENT_QUOTES), 5, 60), true);
	...
	$collect_form->addElement(new JieqiFormTextArea($jieqiLang["article"]["rule_chapter_ivip"], "ivip", htmlspecialchars(jieqi_collectstop($jieqiCollect["ivip"]), ENT_QUOTES), 5, 60), true);
